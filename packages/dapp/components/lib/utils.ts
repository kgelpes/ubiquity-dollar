...
export const CREDIT_uAD_ADDRESS = "0x429630355C3Ab8E7AceCD99B78BE2D37Bb939E27";
...
import { getUbiquityCreditContract } from "../utils/contracts";
// getUbiquityCreditContract(creditToken, provider);
new Contract("0x5894cFEbFdEdBe61d01F20140f41c5c49AedAe97", credit.abi, provider);

const creditTokenSymbol = await contract.deploy(ERC20Token, "Ubiquity Credit", "uCR", 18);
