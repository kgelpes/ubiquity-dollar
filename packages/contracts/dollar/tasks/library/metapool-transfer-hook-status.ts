...
export const description = "Displays transfer hook status on the uAD-3crv metapool";
export const action = (): ActionType<any> => metapoolTransferHookStatus;

async function metapoolTransferHookStatus(taskArgs: { receiver: string; manager: string }, { ethers }) {
