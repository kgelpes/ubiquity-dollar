...
export const description = "Disperses tokens to a list of addresses"; // { "percent": number, "address": string, "name": string }[]
export const params = {
  investors: "A path to a json file containing a list of beneficiaries",
};
export const optionalParams = {
  token: ["Token address", ubiquityGovernanceTokenAddress, types.string],
};
export const action = (): ActionType<any> => disperse;
