...
<<<<<<<< HEAD:packages/contracts/src/dollar/core/TWAPOracleDollar3pool.sol
...
>>>>>>>> d07f5405 (Updated product names according to previous PR):packages/contracts/src/dollar/TWAPOracleDollar3pool.sol
        pool = _pool;
