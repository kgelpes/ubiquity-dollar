...
contract DepositState is LiveTestHelper {
    ...
    function setUp() public virtual override {
        ...
        twapTimestamp = twapOracle.pricesBlockTimestampLast();
        console.log("twapTimestamp", twapTimestamp, address(twapOracle));
        console.log(
            "twapTimestamp",
            twapOracle.consult(address(uAD)),
            address(uAD)
        );
    }
}
