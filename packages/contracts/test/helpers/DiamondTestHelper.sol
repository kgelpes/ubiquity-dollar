...
contract DiamondTestHelper is IDiamondCut, IDiamondLoupe, Test {
    ...
    function removeElement(uint256 index, bytes4[] memory array)
        public
        pure
    ...
    function removeElement(bytes4 el, bytes4[] memory array)
        public
        pure
        returns (bytes4[] memory)
    {
    ...
    function containsElement(bytes4[] memory array, bytes4 el)
        public
        pure
        returns (bool)
    {
    ...
    function containsElement(address[] memory array, address el)
        public
        pure
        returns (bool)
    {
    ...
    function sameMembers(bytes4[] memory array1, bytes4[] memory array2)
        public
        pure
        returns (bool)
    {
